...
const pagePaslaugos = require('../pages/paslaugos.js');
const pageReceptai = require('../pages/receptai');
const pageKepimas = require('../pages/paslaugos/kepimas');
const pagePagardinimas = require('../pages/paslaugos/pagardinimas');
const pageVezimas = require('../pages/paslaugos/vezimas');
const pageVirimas = require('../pages/paslaugos/virimas');
...
server.routes = {
    ...
    'paslaugos': pagePaslaugos,
    'paslaugos/kepimas': pageKepimas,
    'paslaugos/pagardinimas': pagePagardinimas,
    'paslaugos/vezimas': pageVezimas,
    'paslaugos/virimas': pageVirimas, 

    // 'receptai/blynai': 'receptai/blynai',
    // 'receptai/duona': 'receptai/duona',
    // 'receptai/cepelinai': 'receptai/cepelinai',
};
...
server.init = () => {
    ...
    server.httpServer.listen(port, () => {
        console.log(`Nepaspaudes ant http://localhost:${port} nesuzinosi`);
    })
}
